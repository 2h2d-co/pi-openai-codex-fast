...
4. GitHub Actions stages the exact packed tarball on npm via trusted publishing with npm provenance, then creates a GitHub Release with that tarball and `SHA256SUMS`.
